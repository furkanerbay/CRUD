...
namespace CRUD
{
    public partial class Iller : Form
    {
        ...
        {
            con.Open();
            SqlCommand com = new SqlCommand("exec dbo.IlEkle '" + textBox2.Text + "'", con);
            com.ExecuteNonQuery();
            con.Close();
        ...
        void LoadAllRecords()
        {
            SqlCommand com = new SqlCommand("exec dbo.IlGetir", con);
        ...
        {
            con.Open();
            SqlCommand com = new SqlCommand("exec dbo.IlGuncelle '" + int.Parse(textBox1.Text) + "','" + textBox2.Text + "'", con);
            com.ExecuteNonQuery();
            con.Close();
        ...
        {
            con.Open();
            SqlCommand com = new SqlCommand("exec dbo.IlSil '" + int.Parse(textBox1.Text) + "'", con);
            com.ExecuteNonQuery();
            con.Close();
